...
/// <summary>
/// From Iteration10.<br/>
/// Replaced stack allocation with managed heap allocation.<br/>
/// Fixed stack overflow, no consistent runtime effect.
/// </summary>
internal static unsafe class Iteration12
{
    private class Grid
    {
    ...
    public static void Run()
    {
        ...
        var primaryGridArray = new bool[iRowCount * iColumnCount];
        var secondaryGridArray = new bool[iRowCount * iColumnCount];
        fixed (bool* primaryGridCells = primaryGridArray, secondaryGridCells = secondaryGridArray)
        {
